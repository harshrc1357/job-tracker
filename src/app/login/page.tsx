const ERROR_MESSAGES: Record<string, string> = {
  forbidden: "That Google account isn't allowed to sign in here.",
  ...
  return (
    <div className="login-shell">
      <div className="login-card">
        <div className="login-mark">JT</div>
        <h1>Job Tracker</h1>
        <p className="login-sub">Sign in with the Google account this dashboard is set up for.</p>
        ...
        <p className="login-foot">Access is limited to one account.</p>
      </div>
    </div>
  );
}
